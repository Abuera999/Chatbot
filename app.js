...
app.get('/bot', (req, res) => {
    ...
    if (conversationHistory.length === 0) {
        // Push the initial bot message if the history is empty
        conversationHistory.push({
            prompt: "Hello", 
            response: "I'm an AI assistant responsible for providing detailed feedback on students' strengths, weaknesses, understanding, and analytical skills by reviewing the conversation history."
        });
    }
